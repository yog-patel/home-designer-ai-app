  ...
  const features = [
    {
      ...
      onAction: () => dispatch(setActiveTab('create')),
    },
    {
      title: 'Exterior Design',
      subtitle: 'Snap your home, pick a vibe, let AI craft the facade!',
      imageUrl: 'https://images.unsplash.com/photo-1570129477492-45ac003d2e0f?w=400&h=300&fit=crop',
      onAction: () => dispatch(setActiveTab('create')),
    },
    {
      title: 'Garden Design',
      subtitle: 'Choose a style and give your garden a whole new vibe with AI!',
      imageUrl: 'https://images.unsplash.com/photo-1585399121957-c02db5e18a75?w=400&h=300&fit=crop',
      onAction: () => dispatch(setActiveTab('create')),
    },
    {
      title: 'Reference Style',
      subtitle: 'Show AI what you like and let it apply it to your space!',
